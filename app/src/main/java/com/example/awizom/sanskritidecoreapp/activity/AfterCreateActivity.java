...
import com.example.awizom.sanskritidecoreapp.adapter.RoomListAdapter;
import com.example.awizom.sanskritidecoreapp.config.AppConfig;
import com.example.awizom.sanskritidecoreapp.fragment.DatePickerFragment;
...
public class AfterCreateActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    private ImageButton exit, share, print;
    int morderid = 0;
    String buttonname = "";
    String orderid = "";
    String actualorder = "";
    ...
    private class GETLoadDataList extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.isEmpty()) {
                ...
                //materialIdSelected = new Gson().fromJson(result, getType);
    ...
    private class POSTAddCustomer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result.isEmpty()) {
                progressDialog.dismiss();
                //  Toast.makeText(getApplicationContext(), "Invalid request", Toast.LENGTH_SHORT).show();
                startActivity(intent = new Intent(getApplicationContext(), CustomerListActivity.class));
            } else {
                Gson gson = new Gson();
    ...
    private class getCustomerList extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result.isEmpty()) {
                ...
                c_name.setAdapter(adapter);//setting the adapter materialIdSelected into the AutoCompleteTextView
