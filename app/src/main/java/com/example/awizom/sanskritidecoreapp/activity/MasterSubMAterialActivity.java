...
import com.example.awizom.sanskritidecoreapp.adapter.MasterSubMaterialAdapter;
...
public class MasterSubMAterialActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    private String result = "";
    List<RoomModel> RoomModels;
    MasterSubMaterialAdapter adapter;
    ImageButton addRoom;
    private Button add, cancel;
    ArrayList<String> room_type = new ArrayList<>();
    private EditText room_name,measur;;
    ...
    private void initView() {
        ...
        toolbar.setTitle("Sub Material List");
    ...
    private void getRoomList() {
        ...
        try {
            ...
            if (result.isEmpty()) {
                ...
                adapter = new MasterSubMaterialAdapter(this, RoomModels);
    ...
    private void postAddRoom() {
        ...
        String ms =  measur.getText().toString();

        try {

            result = new OrderHelper.PostSubMaterialMaster().execute("0",addtexttype.toString().trim().toString(),ms.toString().trim()).get();
