...
import com.example.awizom.sanskritidecoreapp.adapter.OrderCustomerListAdapter;
...
public class GetCustomerOrderListActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    private String result = "";
    List<OrderNewOne> orderList;
    OrderCustomerListAdapter adapter;
    ...
    private void getOrderList() {
        try {
            ...
            result = new OrderHelper.GetcustomerOrderDetails().execute(SharedPrefManager.getInstance(getApplicationContext()).getUser().access_token).get();
            if (result != null) {
                ...
                adapter = new OrderCustomerListAdapter(this, orderList);
