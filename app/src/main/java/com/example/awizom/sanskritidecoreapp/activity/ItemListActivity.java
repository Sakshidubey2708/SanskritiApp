...
public class ItemListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void allOkButtonRoomLevel() {
        ...
        try {
            ...
            //      progressDialog.show();
            new allokButtonRoomLevel().execute(SharedPrefManager.getInstance(ItemListActivity.this).getUser().access_token);

        } catch (Exception e) {

            e.printStackTrace();
            //       progressDialog.dismiss();
            Toast.makeText(ItemListActivity.this, "Error: " + e, Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(mCtx, "Error: " + e, Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(String result) {
            if (result.isEmpty()) {
                ...
                Toast.makeText(ItemListActivity.this, jsonbodyres.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private class getCatalog extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result.isEmpty()) {
                ...
                catadapter = new ArrayAdapter<String>(ItemListActivity.this, android.R.layout.select_dialog_item, cateloglist);
