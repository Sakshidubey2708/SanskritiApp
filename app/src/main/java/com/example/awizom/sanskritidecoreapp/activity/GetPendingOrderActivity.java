...
import com.example.awizom.sanskritidecoreapp.adapter.GetPendingOrderAdapter;
...
public class GetPendingOrderActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    private String result = "";
    List<OrderNewOne> orderNewOnes;
    GetPendingOrderAdapter adapter;
    ...
    private void initView() {
        ...
        toolbar.setTitle("Pending Order List");
    ...
    private void getPendingAmount() {
        ...
        try {
            ...
            result = new OrderHelper.GetPendingOrderListDetails().execute(SharedPrefManager.getInstance(this).getUser().access_token).get();
            if (result.isEmpty()) {
                ...
                adapter = new GetPendingOrderAdapter(this, orderNewOnes);
