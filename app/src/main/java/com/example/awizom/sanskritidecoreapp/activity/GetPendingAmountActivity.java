...
import com.example.awizom.sanskritidecoreapp.adapter.GetPendingAmountAdapter;
...
public class GetPendingAmountActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    private String result = "";
    List<OrderNewOne> orderNewOnes;
    GetPendingAmountAdapter adapter;
    ...
    private void initView() {
        ...
        toolbar.setTitle("Pending Amount List");
    ...
    private void getPendingAmount() {
        ...
        try {
            ...
            result = new OrderHelper.GetPendingAmountListDetails().execute(SharedPrefManager.getInstance(this).getUser().access_token).get();
            if (result.isEmpty()) {
                ...
                adapter = new GetPendingAmountAdapter(this, orderNewOnes);
